 ...
 *
 * Shading algorithms calculate the visibility of geometry triangles 
...
public:
	 ...
	 * definitions of the geometry model.
	 *
	...
	/**
	 * Calculates the visibility of geometry triangles from a specific direction.
	 *
	 ...
	 *
	 * @param v_rel_hat The normalized relative velocity vector in the geometry's body frame.
