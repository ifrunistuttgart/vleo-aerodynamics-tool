 ...
 *
 * This interface allows for programmatic rotation of individual meshes
 * of a geometry, which is essential for simulating articulated parts like solar arrays.
 */
