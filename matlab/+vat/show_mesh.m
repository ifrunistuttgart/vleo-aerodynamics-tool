function show_mesh(geometry, triangle_visbility, velocity__m_per_s)
    % SHOW_MESH Visualizes the geometry with shading information.
    ...
    MexGateway("Visualization.show_mesh", int32(geometry.handle_), triangle_visbility, velocity__m_per_s);
end